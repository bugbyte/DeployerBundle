                ...
                ->arrayNode('prod')
                    ->children()
                        ->scalarNode('project_name')
                            ...
                            ->cannotBeEmpty()
                        ->end()
                        ->scalarNode('database_patcher')->defaultValue('vendor/bugbyte/deployer/database-patcher.php')->end()
                        ->scalarNode('datadir_patcher')->defaultValue('vendor/bugbyte/deployer/datadir-patcher.php')->end()
                        ...
                        ->scalarNode('apc_deploy_version_path')->defaultValue('')->end()
                        ->scalarNode('apc_deploy_setrev_url')->defaultValue('')->end()
                    ->end()
                ->end()
            ->end();
